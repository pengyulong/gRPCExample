...
void TextFeature::Stub::experimental_async::ServerStreamRPC(::grpc::ClientContext* context, ::textfeature::sentenceRequest* request, ::grpc::experimental::ClientReadReactor< ::textfeature::orderkeyResponse>* reactor) {
  ::grpc::internal::ClientCallbackReaderFactory< ::textfeature::orderkeyResponse>::Create(stub_->channel_.get(), stub_->rpcmethod_ServerStreamRPC_, context, request, reactor);
}
...
void TextFeature::Stub::experimental_async::ClientStreamRPC(::grpc::ClientContext* context, ::textfeature::SummaryKeyWords* response, ::grpc::experimental::ClientWriteReactor< ::textfeature::docsRequest>* reactor) {
  ::grpc::internal::ClientCallbackWriterFactory< ::textfeature::docsRequest>::Create(stub_->channel_.get(), stub_->rpcmethod_ClientStreamRPC_, context, response, reactor);
}
...
void TextFeature::Stub::experimental_async::BidirectionalStreamRPC(::grpc::ClientContext* context, ::grpc::experimental::ClientBidiReactor< ::textfeature::docsRequest,::textfeature::orderkeyResponse>* reactor) {
  ::grpc::internal::ClientCallbackReaderWriterFactory< ::textfeature::docsRequest,::textfeature::orderkeyResponse>::Create(stub_->channel_.get(), stub_->rpcmethod_BidirectionalStreamRPC_, context, reactor);
}
